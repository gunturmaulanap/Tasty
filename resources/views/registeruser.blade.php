            ...
            <div class="container-fluid h-custom">
              <div class="row d-flex justify-content-center align-items-center h-100">
                <div class="col-md-9 col-lg-6 col-xl-5">
                  <img src="assets/images/logo1.png" class="img-fluid" alt="Sample image" style="padding-right: 50px;" />
                </div>
                <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                  <form>
                    <div class="d-flex flex-row align-items-center justify-content-center justify-content-lg-start">
                      <p class="lead fw-normal mb-0 me-3" style="color: #CCCC;">Sign up with</p>
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                      ...
                      <div class="form-check mb-0">
                        ...
                        <label class="form-check-label" style="color: #CCCC;"  for="form2Example3"> Remember me </label>
                      </div>
                    ...
                    <div class="text-center text-lg-start mt-4 pt-2">
                      ...
                      <p class="small fw-bold mt-2 pt-1 mb-0">have an account? <a href="#!" class="link-primary">Login</a></p>
                    </div>
                  </form>
                </div>
              </div>
