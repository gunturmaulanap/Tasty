...
<body>
    ...
    <div class="container">
        <div class="row">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="header-text">
                            <h6>Welcome To VY Store</h6>
                            <h4><em>Temukan</em> dunia game terbaik di satu tempat!</h4>
                            <div class="main-button" style="text-align: center">
                                <a href="index">Browse Now</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- ***** Banner End ***** -->
            <div class="container px-4 px-lg-5" style="margin-top: 70px">
                    ...
                    <div class="col-md-10 col-lg-8 mx-auto text-center">
                        ...
                        <form class="form-signup" id="contactForm" data-sb-form-api-token="API_TOKEN">
                            ...
                            <div class="row input-group-newsletter">
                                ...
                                <div class="col-auto"><button class="btn btn-primary enabled" id="submitButton" type="submit">Notify Me!</button></div>
                            </div>
